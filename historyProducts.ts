...
export const fetchAllProducts = createAsyncThunk<IProduct[], void, { state: RootState; rejectValue: string }>("historyProductsData/fetchAllProducts", async (_, { getState, rejectWithValue, dispatch }) => {
